...
export const ngdoc: any = {
  ...
  "BsDatepickerDirective": {
    ...
    "inputs": [
      ...
      },
      {
        "name": "weekPicker",
        "type": "boolean",
        "description": "<p>Indicates whether date should be selected by week or not</p>\n"
      }
    ],
    "outputs": [
      {
  ...
  "BsDatepickerWeekDecoratorDirective": {
    "fileName": "src/datepicker/themes/bs/bs-datepicker-week-decorator.directive.ts",
    "className": "BsDatepickerWeekDecoratorDirective",
    "description": "",
